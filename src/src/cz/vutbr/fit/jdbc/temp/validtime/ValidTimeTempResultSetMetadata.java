...
/**
 * JDBC royhranie pre ziskanie metadat o danej DB
 * @author Filip Fekiac
 */
public class ValidTimeTempResultSetMetadata implements ResultSetMetaData {
    private final ResultSetMetaData rsMeta;
    
    public ValidTimeTempResultSetMetadata(ResultSetMetaData _metaData) {
        rsMeta = _metaData;
    }
