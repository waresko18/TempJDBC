...
/**
 * trieda implementuje rozhranie JDBC pre ziskavanie vysledku a pracu s nim 
 * @author Filip Fekiac
 */
public class TSQL2LIBTempResultSet implements ResultSet {

    private final TSQL2ResultSet resultSet;

    public TSQL2LIBTempResultSet(TSQL2ResultSet rs) {
        resultSet = rs;
    }
